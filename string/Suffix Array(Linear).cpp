/*
    ...
    *** From Atcoder Library
    (1) vector<int> suffix_array(string s)  -->  O(n)
    (2) vector<int> suffix_array<T>(vector<T> s)  -->  O(nlogn)
    (3) vector<int> suffix_array(vector<int> s, int upper)  -->  O(n + upper), upper <= 1e8, 0 <= x <= upper(x is in s)
