 ...
 * Source: https://codeforces.com/blog/entry/103726
 *
...
void pushSub(int u, bool o, const Lazy &lazy)
{
    ...
    tr[u].sub += lazy;
    tr[u].slazy += lazy;
    if (!tr[u].fake && o) pushPath(u, lazy);
    else tr[u].all = tr[u].path + tr[u].sub;
}
...
void add(int u, int v)
{
    ...
    int w = freeList.back();
    freeList.pop_back();
    attach(w, 2, tr[u].ch[2]), attach(w, 3, v), attach(u, 2, w);
}
